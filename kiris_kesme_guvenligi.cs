...
{
    public class KirisKesmeGuvenligiUI
    {
        private Form1 _form;
        ...
        public KirisKesmeGuvenligiUI(Form1 form, Func<cSapModel> getSapModel, 
        ...
        public void Initialize(TabPage page)
        {
            ...
            pnlLeft.Controls.Add(new Label { 
                Text = "Hesaplama parametreleri buraya gelecek.", 
